...
public class CommentResource {
    ...
    public ResponseEntity<Comment> createComment(@Valid @RequestBody Comment comment) throws URISyntaxException {
        ...
        mentions.forEach(mention -> commentService.sendMentionCommentEvent(result, mention));
    ...
    public ResponseEntity<Comment> getComment(@PathVariable Long id) {
        ...
        return Optional.ofNullable(commentRepository.findOneWithEagerRelationships(id))
