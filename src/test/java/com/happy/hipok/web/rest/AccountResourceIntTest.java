...
import com.happy.hipok.web.rest.app.AppAccountResource;
...
public class AccountResourceIntTest {
    ...
    public void setup() {
        ...
        doNothing().when(mockMailService).sendActivationEmail((ExtendedUser) anyObject(), anyString());

        AppAccountResource accountResource = new AppAccountResource();
        ReflectionTestUtils.setField(accountResource, "userRepository", userRepository);
        ReflectionTestUtils.setField(accountResource, "userService", userService);
        ReflectionTestUtils.setField(accountResource, "mailService", mockMailService);

        AppAccountResource accountUserMockResource = new AppAccountResource();
    ...
    public void testNonAuthenticatedUser() throws Exception {
        restUserMockMvc.perform(get("/app/authenticate")
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        restUserMockMvc.perform(get("/app/account")
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    public void testRegisterInvalidEmail() throws Exception {
        RegisterAppExtendedUserDTO u = new RegisterAppExtendedUserDTO(
            "bob",              // login
            "password",         // password
            "Bob",              // firstName
            "Green",            // lastName
        ...
        u.setTitleRefId(1L);
        u.setRppsRefNumber("10000542851");
