...
describe('Directive Tests ', function () {
    ...
    beforeEach(inject(function($compile, $rootScope, $injector) {
        ...
        $httpBackend.whenGET(/app\/account\?cacheBuster=\d+/).respond({});
    ...
    describe('Password strength', function () {
        xit("Should display the password strength bar", function() {
            expect(elm.find('ul').length).toEqual(1);
            expect(elm.find('li').length).toEqual(5);
        });

        xit("Should change the first 2 points of the strength bar", function() {
        ...
        xit("Should change the first 4 points of the strength bar", function() {
            scope.$apply(function() {
